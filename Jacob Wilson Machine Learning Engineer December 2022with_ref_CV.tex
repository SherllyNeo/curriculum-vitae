...
{\center
{\Large\bf Jacob Wilson \\ Machine Learning Engineer \vspace{0.1in} }
...
{\it code examples available upon request}

\section*{\bf Summary}

I am a creative and driven ML Engineer with an extensive skillset and possess the obsessive work ethic and curiosity charateristic of a top level engineer.
...
\item Had sole responsability over machine learning projects and meeting deliverables to the requirements of lay customers.
...
\item Juggling
\end{itemize}
{\it performances available upon request}
